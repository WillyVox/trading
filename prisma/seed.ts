  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        ...
        value: "Yes",
        jurisdiction: "AU",
        sourceUrl: "https://support.swyftx.com/en/articles/11741112-deposit-australian-dollars",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
    ...
    fees: [
      {
        ...
        valueType: FeeValueType.TIERED,
        percentage: 0.6,
        displayValue: "0.6% standard; tiered down to 0.1% based on rolling 30-day trading volume",
        jurisdiction: "AU",
        sourceUrl: "https://support.swyftx.com/en/articles/12005536-our-trading-fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        ...
        valueType: FeeValueType.VARIABLE,
        displayValue: "Variable by asset and market conditions; charged separately from the trading fee",
        jurisdiction: "AU",
      ...
      },
      {
        ...
        valueType: FeeValueType.PERCENTAGE,
        percentage: 1.875,
        displayValue: "1.875% charged by Stripe; Swyftx does not charge an additional card-deposit fee",
        jurisdiction: "AU",
        sourceUrl: "https://support.swyftx.com/en/articles/12004727-fees-for-deposits-and-withdrawals",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
    ...
    features: [
      { featureType: ProviderFeatureType.AUD_DEPOSITS, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.swyftx.com/en/articles/11741112-deposit-australian-dollars", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.AUD_WITHDRAWALS, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.swyftx.com/en/articles/12004727-fees-for-deposits-and-withdrawals", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.PAYID, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.swyftx.com/en/articles/11741112-deposit-australian-dollars", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.BANK_TRANSFER, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.swyftx.com/en/articles/11741112-deposit-australian-dollars", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.CARD_DEPOSIT, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.swyftx.com/en/articles/11741112-deposit-australian-dollars", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.MOBILE_APP, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://swyftx.com/au/features/", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.RECURRING_BUYS, label: "Auto Invest", available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://swyftx.com/au/features/", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.TWO_FACTOR_AUTH, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://swyftx.com/facts/", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.COLD_STORAGE, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://swyftx.com/facts/", verifiedAt: new Date("2026-09-11") },
    ],
    prosCons: [
      {
        type: ProviderProsConsType.PRO,
        label: "Free AUD deposits via PayID and bank transfer, with free AUD withdrawals",
        sourceUrl: "https://support.swyftx.com/en/articles/12004727-fees-for-deposits-and-withdrawals",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        type: ProviderProsConsType.PRO,
        label: "Tiered trading fee can decrease from 0.6% to 0.1% as 30-day trading volume increases",
        sourceUrl: "https://support.swyftx.com/en/articles/12005536-our-trading-fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      ...
      {
        type: ProviderProsConsType.LIMITATION,
        label: "Crypto trades incur a variable spread in addition to the trading fee",
        sourceUrl: "https://swyftx.com/spreads/",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        type: ProviderProsConsType.LIMITATION,
        label: "The lowest 0.1% trading-fee tier requires at least $6 million AUD of rolling 30-day trading volume",
        sourceUrl: "https://support.swyftx.com/en/articles/12005536-our-trading-fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
    ...
    sources: [
      { label: "Official website", url: "https://swyftx.com", sourceType: ProviderSourceType.OFFICIAL_WEBSITE },
      { label: "Official fees", url: "https://support.swyftx.com/en/articles/12005536-our-trading-fees", sourceType: ProviderSourceType.OFFICIAL_FEES },
      { label: "Official deposit and withdrawal fees", url: "https://support.swyftx.com/en/articles/12004727-fees-for-deposits-and-withdrawals", sourceType: ProviderSourceType.OFFICIAL_FEES },
      { label: "Official platform facts", url: "https://swyftx.com/facts/", sourceType: ProviderSourceType.OFFICIAL_WEBSITE },
    ],
    regulations: [
      {
        jurisdiction: "AU",
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        ...
        value: "Yes",
        jurisdiction: "AU",
        sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/360026860233-How-to-deposit-AUD",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
    ...
    fees: [
      {
        ...
        valueType: FeeValueType.TIERED,
        percentage: 0.85,
        displayValue: "0.85% at the lowest volume tier, decreasing to 0.10% above $5m rolling 30-day volume",
        jurisdiction: "AU",
        sourceUrl: "https://www.btcmarkets.net/fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      ...
      },
      {
        ...
        valueType: FeeValueType.VARIABLE,
        displayValue: "Variable spread included in quoted price; no additional Simple Trade trading fee",
        jurisdiction: "AU",
        sourceUrl: "https://www.btcmarkets.net/fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        ...
        displayValue: "Free",
        jurisdiction: "AU",
        sourceUrl: "https://www.btcmarkets.net/learn/get-started-with-btc-markets/how-to-fund-your-account/deposit-using-payid",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
    ],
    features: [
      { featureType: ProviderFeatureType.AUD_DEPOSITS, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/360026860233-How-to-deposit-AUD", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.PAYID, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://www.btcmarkets.net/learn/get-started-with-btc-markets/how-to-fund-your-account/deposit-using-payid", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.BANK_TRANSFER, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/19573488554777-Direct-deposits-using-BSB-and-account-number", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.CARD_DEPOSIT, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/24952179952537-How-to-deposit-using-a-bank-card", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.MOBILE_APP, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://www.btcmarkets.net/products/mobile-app", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.API_ACCESS, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://docs.btcmarkets.net/", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.TWO_FACTOR_AUTH, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/360001821168-Account-Security-on-BTC-Markets", verifiedAt: new Date("2026-09-11") },
      { featureType: ProviderFeatureType.COLD_STORAGE, available: true, verificationStatus: VerificationStatus.VERIFIED, sourceUrl: "https://www.btcmarkets.net/frequently-asked-questions", verifiedAt: new Date("2026-09-11") },
    ],
    prosCons: [
      {
        type: ProviderProsConsType.PRO,
        label: "Supports AUD funding through PayID, direct bank transfer and card deposits",
        sourceUrl: "https://support.btcmarkets.net/hc/en-us/articles/360026860233-How-to-deposit-AUD",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        type: ProviderProsConsType.PRO,
        label: "Offers both an exchange order book and a simpler fixed-quote Simple Trade interface",
        sourceUrl: "https://www.btcmarkets.net/fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
      {
        type: ProviderProsConsType.PRO,
        label: "Supports 2FA, off-site cold-wallet storage and full-reserve reconciliation",
      ...
      {
        type: ProviderProsConsType.LIMITATION,
        label: "Simple Trade pricing includes a variable spread rather than using the exchange fee schedule",
        sourceUrl: "https://www.btcmarkets.net/fees",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: new Date("2026-09-11"),
      },
    ...
    sources: [
      { label: "Official website", url: "https://www.btcmarkets.net", sourceType: ProviderSourceType.OFFICIAL_WEBSITE },
      { label: "Official fee schedule", url: "https://www.btcmarkets.net/fees", sourceType: ProviderSourceType.OFFICIAL_FEES },
      { label: "Official AUD deposit documentation", url: "https://support.btcmarkets.net/hc/en-us/articles/360026860233-How-to-deposit-AUD", sourceType: ProviderSourceType.OFFICIAL_SUPPORT },
      { label: "Official regulation information", url: "https://www.btcmarkets.net/regulation", sourceType: ProviderSourceType.OFFICIAL_WEBSITE },
    ],
    regulations: [
      {
        jurisdiction: "AU",
        regulator: "AUSTRAC",
        status: "Registered Digital Currency Exchange and subject to Australian AML/CTF requirements",
