  ...
  offering: {
    ...
    fees: [
      ...
      },
      {
        ...
        notes:
          "USD investment-account withdrawals have different fee treatment and are not represented by this AUD-specific row.",
        sourceUrl: FEES,
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
        reviewDueAt: REVIEW_DUE,
    ...
    prosCons: [
      {
        ...
        label:
          "AUD account funding and withdrawals are available for eligible Australian users",
        sourceUrl: "https://www.etoro.com/au/trading/currency-accounts/",
        jurisdiction: "AU",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
      ...
      {
        type: OfferingProsConsType.PRO,
        label: "Supported crypto can be transferred to the eToro Crypto Wallet",
        sourceUrl: WALLET,
        jurisdiction: "AU",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
      },
      {
        ...
        label:
          "A 1% fee applies when opening and another 1% applies when closing a crypto position",
        sourceUrl: FEES,
        jurisdiction: "AU",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
      },
      {
        type: OfferingProsConsType.LIMITATION,
        label:
          "Platform-to-eToro-Wallet crypto transfers carry a 2% fee subject to published limits",
        sourceUrl: WALLET_FEES,
        jurisdiction: "AU",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
      },
      {
        type: OfferingProsConsType.LIMITATION,
        label:
          "eToro states non-leveraged cryptoasset trading is unregulated in Australia",
        detail:
          "Consumer protections that apply to regulated financial services/products do not apply to non-leveraged cryptoassets in the same way. Leveraged crypto positions are CFDs with different regulatory treatment.",
        sourceUrl: MARKETS,
        jurisdiction: "AU",
        verificationStatus: VerificationStatus.VERIFIED,
        verifiedAt: CHECKED,
