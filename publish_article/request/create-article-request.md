...
Compare links are about to move. The compare pages are still at /share-trading/compare and /crypto/exchanges/compare. If we build the new guides first, we will have to edit them again after the route registry work.
...
From To
Guide A Guide B; the three share-trading guides; the three crypto guides; /share-trading; /share-trading/commsec; /share-trading/cmc-invest; /share-trading/compare; /crypto/exchanges; two or three exchange profiles; /crypto/exchanges/compare; /methodology/editorial-policy; /guides
