...
const HEADINGS = [
  { id: "investing-vs-buying", text: "Investing vs. just buying crypto", level: 2 as const },
  { id: "understand-the-asset-class", text: "Understand what you're investing in", level: 2 as const },
  { id: "know-your-risk-tolerance", text: "Know your risk tolerance first", level: 2 as const },
  { id: "how-much-to-invest", text: "How much of your money should go into crypto?", level: 2 as const },
  { id: "dollar-cost-averaging", text: "Dollar-cost averaging: a common beginner strategy", level: 2 as const },
  { id: "researching-a-project", text: "Researching a crypto project before you buy", level: 2 as const },
  { id: "avoiding-scams", text: "Avoiding common crypto scams", level: 2 as const },
  { id: "storage-and-security", text: "Storage and security", level: 2 as const },
  { id: "tax-in-australia", text: "Crypto and tax in Australia", level: 2 as const },
...
export default function HowToStartInvestingInCryptoForBeginnersPage() {
  const trail = breadcrumbTrail([{ name: "How to Start Investing in Crypto for Beginners", path: PATH }]);
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_280px]">
          <article className="min-w-0 max-w-3xl">
            ...
            <div className="prose prose-headings:font-display prose-headings:text-navy mt-8 max-w-none">
              ...
              <p>
                There&apos;s a meaningful difference between buying a small amount of crypto out of
                curiosity and actually <em>investing</em> in it. Investing implies a plan: a rough idea
              ...
              <h2 id="understand-the-asset-class">Understand what you&apos;re investing in</h2>
              <p>
                Crypto assets are a broad category — cryptocurrencies, tokens, and coins built on
                blockchain networks. Unlike a share, a crypto asset doesn&apos;t represent ownership in
                a company with earnings or assets behind it; its value comes almost entirely from
                supply, demand, and how useful or trusted the network behind it is perceived to be. That
                makes it a fundamentally different kind of asset to shares, property, or cash — and one
                that Australia&apos;s Moneysmart explicitly flags as high-risk, alongside CFDs and forex
                trading.
              </p>

              <h2 id="know-your-risk-tolerance">Know your risk tolerance first</h2>
              <p>
                Before choosing an amount, be honest about how you&apos;d react if that amount fell by
                half in a week — because crypto assets have historically done exactly that, more than
                once. If that thought is genuinely distressing rather than merely uncomfortable,
                that&apos;s useful information about how much (if any) crypto exposure suits you right
                now.
              </p>

              <h2 id="how-much-to-invest">How much of your money should go into crypto?</h2>
              <p>
                There&apos;s no universal percentage that applies to everyone — it depends on your
                income, existing savings, debt, and other financial goals. What most beginner-friendly
                guidance agrees on is the principle, not the number: treat crypto as money you could
                afford to lose entirely without affecting your ability to pay rent, cover an emergency,
              ...
              <h2 id="dollar-cost-averaging">Dollar-cost averaging: a common beginner strategy</h2>
              <p>
                Rather than investing a lump sum at once, <strong>dollar-cost averaging (DCA)</strong>{" "}
                means investing a smaller, fixed amount at regular intervals — say, weekly or monthly —
                regardless of the price on that particular day. This doesn&apos;t protect against an
                asset losing value overall, but it does smooth out the impact of buying at a single,
                potentially high, price point, and it removes the pressure of trying to time the market.
              </p>

              <h2 id="researching-a-project">Researching a crypto project before you buy</h2>
              <p>Before buying a specific asset, it&apos;s worth looking into:</p>
              <ul>
                <li>What problem the network or token is actually trying to solve.</li>
                <li>How long it&apos;s been operating, and how the team behind it communicates publicly.</li>
                <li>Trading volume and liquidity — thinly-traded tokens can be harder to sell at a fair price.</li>
                <li>Whether independent sources (not just the project&apos;s own marketing) corroborate its claims.</li>
              </ul>
              ...
              <p>
                Crypto&apos;s combination of popularity and irreversible transactions makes it a
                frequent target for scammers. Common patterns include unsolicited investment
                &quot;opportunities&quot; from strangers or new online contacts, promises of guaranteed
                or unusually high returns, fake or cloned trading platforms, and pressure to act
                quickly or keep the opportunity secret. Genuine investments don&apos;t require secrecy
                or urgency — treat both as warning signs.
              </p>

              <h2 id="storage-and-security">Storage and security</h2>
              <p>
                As your holdings grow, consider moving crypto off the exchange and into a personal
                wallet you control. A hardware wallet keeps your private keys on a device that&apos;s
                never connected to the internet, which meaningfully reduces exposure to online attacks
                — at the cost of taking on full responsibility for keeping that device and its backup
                phrase safe yourself.
              </p>
              ...
              <p>
                ...
                <strong>Capital Gains Tax (CGT)</strong>. Broadly, buying crypto with Australian dollars
                and simply holding it isn&apos;t a taxable event, but selling it, swapping it for another
                crypto asset, or spending it generally is. Keeping accurate records — dates, amounts,
                and AUD values — from your very first transaction makes this far easier at tax time. Tax
                treatment can be detailed and is subject to change, so check the ATO&apos;s current
                guidance or speak with a tax professional for your specific situation.
              </p>
