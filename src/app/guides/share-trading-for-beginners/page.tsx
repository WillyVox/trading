...
const HEADINGS = [
  { id: "what-is-share-trading", text: "What is share trading?", level: 2 as const },
  { id: "how-it-works", text: "How share trading actually works", level: 2 as const },
  { id: "ways-to-buy-shares", text: "Ways to buy shares in Australia", level: 2 as const },
  { id: "direct-ownership", text: "Buying shares directly (the ASX)", level: 3 as const },
  { id: "managed-and-etfs", text: "Managed funds and ETFs", level: 3 as const },
  { id: "cfds-warning", text: "CFDs and leveraged trading (higher risk)", level: 3 as const },
  { id: "how-to-start", text: "How to start share trading in 6 steps", level: 2 as const },
  { id: "costs-and-fees", text: "Costs and fees to expect", level: 2 as const },
  { id: "risks", text: "Risks every beginner should understand", level: 2 as const },
  { id: "mistakes", text: "Common mistakes beginners make", level: 2 as const },
  { id: "shares-vs-crypto", text: "Share trading vs crypto trading", level: 2 as const },
];
...
export const metadata = buildMetadata({
  ...
  seoTitle: "Share Trading for Beginners (2026) — How to Start Investing in Shares",
  seoDescription:
...
export default function ShareTradingForBeginnersPage() {
  const trail = breadcrumbTrail([{ name: "Share trading for beginners", path: PATH }]);
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_280px]">
          <article className="min-w-0 max-w-3xl">
            ...
            <div className="prose prose-headings:font-display prose-headings:text-navy mt-8 max-w-none">
              ...
              <p>
                Share trading is the buying and selling of shares — small ownership units in a publicly
                listed company. When you own a share, you own a proportional slice of that company: its
                profits, its losses, and (for some companies) a share of the dividends it pays out. In
                Australia, the vast majority of share trading happens on the{" "}
                <strong>Australian Securities Exchange (ASX)</strong>, the country&apos;s main public
                market for listed companies.
              </p>
              <p>
                &quot;Trading&quot; and &quot;investing&quot; are often used interchangeably, but they
                describe different approaches to the same market. Investing usually means buying shares
                and holding them for years, aiming to benefit from a company&apos;s long-term growth and
                dividends. Trading usually means buying and selling more frequently, aiming to profit
                from shorter-term price movements. Most beginners are better served by the investing
                approach — it requires less time, less specialist knowledge, and carries lower
                transaction costs.
              </p>

              <h2 id="how-it-works">How share trading actually works</h2>
              <p>
                Companies list on the ASX to raise money from the public, usually via an{" "}
                <strong>Initial Public Offering (IPO)</strong>. Once listed, their shares can be bought
                and sold between investors on the exchange, and the price moves constantly based on
                supply and demand — how many people want to buy at a given price versus how many want to
                sell.
              </p>
              <p>
                You can&apos;t trade directly on the ASX yourself; you place an order through a licensed
                broker, who routes it to the exchange. When your buy order matches someone else&apos;s
                sell order at an agreed price, the trade executes and the shares move into your name,
                held electronically through the ASX&apos;s settlement system (CHESS) or, with some
                brokers, in a custodial account on your behalf.
              </p>

              <h2 id="ways-to-buy-shares">Ways to buy shares in Australia</h2>
              <p>
                There isn&apos;t just one way to get exposure to shares. The right approach depends on
                how hands-on you want to be and how much risk you&apos;re comfortable taking on.
              </p>

              <h3 id="direct-ownership">Buying shares directly (the ASX)</h3>
              <p>
                This is the most straightforward approach: you open a brokerage account, deposit cash,
                and buy shares in specific companies you&apos;ve chosen — for example a bank, a mining
                company, or a retailer. You own those shares outright, in your name, and can hold them
                for as long as you like.
              </p>

              <h3 id="managed-and-etfs">Managed funds and ETFs</h3>
              <p>
                Instead of picking individual companies, you can buy a single unit that gives you
                exposure to a whole basket of shares. An{" "}
                <strong>Exchange Traded Fund (ETF)</strong> tracks an index (like the ASX 200) or a
                theme, and trades on the exchange just like an ordinary share. This spreads your risk
                across many companies at once, and is one of the most common starting points for
                beginners who don&apos;t want to research individual stocks.
              </p>

              <h3 id="cfds-warning">CFDs and leveraged trading (higher risk)</h3>
              <p>
                A <strong>Contract for Difference (CFD)</strong> lets you speculate on a share&apos;s
                price movement without owning the underlying share — and typically with borrowed money
                (leverage), which magnifies both gains and losses. Regulators have repeatedly flagged
                CFDs as a high-risk product: it&apos;s possible to lose more than your original deposit.
                Most beginners are better off building experience with direct share ownership before
                ever considering a leveraged product.
              </p>
              ...
              <ol>
                <li>
                  <strong>Set a goal and a timeframe.</strong> Are you investing for retirement in 30
                  years, or a house deposit in 5? Your timeframe shapes how much risk makes sense.
                </li>
                <li>
                  <strong>Choose a broker.</strong> Compare brokerage fees per trade, account-keeping
                  fees, the range of shares and ETFs on offer, and whether the broker holds an AFSL.
                </li>
                <li>
                  <strong>Open and verify your account.</strong> You&apos;ll need standard identity
                  documents and a linked bank account — similar to opening any financial account.
                </li>
                <li>
                  <strong>Deposit funds.</strong> Most brokers support bank transfer or BPAY; some offer
                  instant deposits via debit card for a fee.
                </li>
                <li>
                  <strong>Research before you buy.</strong> Read the company&apos;s latest results or the
                  ETF&apos;s product disclosure statement before committing money.
                </li>
                <li>
                  <strong>Place your first order</strong> — either a <em>market order</em> (executes
                  immediately at the current price) or a <em>limit order</em> (only executes at a price
                  you set), then monitor your holdings over time rather than checking them constantly.
                </li>
              </ol>
              ...
              <div className="overflow-x-auto">
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>Brokerage</td>
                      <td>A flat fee or percentage charged each time you buy or sell.</td>
                    </tr>
                    <tr>
                      <td>Bid-ask spread</td>
                      <td>The small gap between the buy price and sell price at any moment.</td>
                    </tr>
                    <tr>
                      <td>Management fee (ETFs/funds)</td>
                      <td>An annual percentage charged for managing a fund or ETF, deducted from returns.</td>
                    </tr>
                    <tr>
                      <td>Account-keeping fee</td>
                      <td>A periodic fee some brokers charge simply for holding an account.</td>
                    </tr>
                    <tr>
                      <td>Currency conversion</td>
                      <td>Applies when buying shares listed outside Australia, e.g. on the US market.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p>
                Small, frequent trades are usually the most fee-inefficient way to invest, since
                brokerage is charged per transaction regardless of size — one reason many beginners
                favour a slower, less frequent buying pattern.
              </p>

              <h2 id="risks">Risks every beginner should understand</h2>
              <ul>
                <li>
                  <strong>Market risk.</strong> Share prices can fall as well as rise, sometimes sharply
                  and without warning.
                </li>
                <li>
                  <strong>Company risk.</strong> An individual company can underperform, cut its
                  dividend, or in the worst case fail entirely.
                </li>
                <li>
                  <strong>Concentration risk.</strong> Putting most of your money into one company or
                  sector magnifies the impact if it performs poorly.
                </li>
                <li>
                  <strong>Liquidity risk.</strong> Smaller, thinly-traded companies can be harder to
                  sell quickly at a fair price.
                </li>
                <li>
                  <strong>Leverage risk.</strong> Products like CFDs can produce losses larger than your
                  original investment.
                </li>
              </ul>
              ...
              <ul>
                <li>Investing money you might need in the short term, then being forced to sell at a loss.</li>
                <li>Chasing a stock after it&apos;s already risen sharply, driven by hype rather than research.</li>
                <li>Putting most of your portfolio into a single company or sector.</li>
                <li>Checking prices daily and reacting emotionally to short-term volatility.</li>
                <li>Ignoring fees — a broker that looks cheap on brokerage can still be expensive overall.</li>
              </ul>

              <h2 id="shares-vs-crypto">Share trading vs crypto trading</h2>
              <p>
                Shares and crypto assets sit at different points on the risk spectrum. A listed company
                has disclosure obligations, audited financials, and a regulator (ASIC) overseeing the
                market it trades on. Crypto assets are typically unregulated in Australia, trade 24/7
                with far higher volatility, and aren&apos;t backed by a company&apos;s earnings at all —
                their value is driven almost entirely by supply, demand, and sentiment.
              </p>
              <p>
            ...
            <GuideSourceList
              sources={[
                ...
                },
                {
                  ...
                  label: "Moneysmart — Investment warnings (CFDs, high-risk products)",
            ...
            <GuideProviderLinks
              ...
              providers={[
                ...
                { slug: "independent-reserve", name: "Independent Reserve", description: "Australian exchange for individuals and businesses." },
              ]}
            />
