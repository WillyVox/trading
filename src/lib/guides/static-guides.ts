import { getStaticGuideArticleImage, STATIC_SLUG_IDS } from "./static-article-slugs";
...
export const STATIC_GUIDES = [
  {
    ...
    featuredImage: getStaticGuideArticleImage(STATIC_SLUG_IDS.TOP_CRYPTO_EXCHANGES),
    featuredImageAlt: "Factors Australians can compare when researching cryptocurrency exchanges",
  ...
  },
  {
    ...
    featuredImage: getStaticGuideArticleImage(STATIC_SLUG_IDS.STEPS_TO_BUY_CRYPTO),
    featuredImageAlt: "Five-step beginner process for buying cryptocurrency in Australia",
    author: "Trading Guide Editorial Team",
  ...
  },
  {
    ...
    category: "getting-started",
    featuredImage: getStaticGuideArticleImage(STATIC_SLUG_IDS.START_INVESTING_IN_CRYPTO),
    featuredImageAlt: "Beginner guide to researching cryptocurrency before investing",
    author: "Trading Guide Editorial Team",
    publishedAt: "2026-09-15",
    updatedAt: "2026-09-15",
    source: "STATIC",
  },
  {
    ...
    featuredImage: getStaticGuideArticleImage(STATIC_SLUG_IDS.SHARE_TRADING_FOR_BEGINNERS),
    featuredImageAlt: "Beginner guide to share trading and investing in Australia",
    author: "Trading Guide Editorial Team",
    publishedAt: "2026-09-15",
    updatedAt: "2026-09-15",
    source: "STATIC",
...
export const STATIC_GUIDE_SLUGS = new Set<string>(STATIC_GUIDES.map((guide) => guide.slug));
...
export function getStaticGuides(category?: string): StaticGuideSummary[] {
  return STATIC_GUIDES.filter((guide) => !category || guide.category === category).map((guide) => ({ ...guide }));
}
