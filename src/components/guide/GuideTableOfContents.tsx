...
export function GuideTableOfContents({ headings }: { headings: Heading[] }) {
  ...
  return (
    <details
      open
      className="border-border bg-panel rounded-2xl border p-4 lg:sticky lg:top-24"
    >
      <summary className="font-display text-navy marker:text-gold cursor-pointer text-sm font-bold tracking-wide uppercase lg:pointer-events-none lg:cursor-default">
        Table of contents
      </summary>
