  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
      ...
      >
        ...
        >
          Try a percentage FX fee
        </h2>
        <p className="text-muted mt-2 text-sm leading-6">
          Enter a hypothetical Australian-dollar amount and an FX fee
          percentage. This mode teaches the arithmetic; it does not use or
        ...
        <div className="mt-6 space-y-5">
          <label className="text-navy block text-sm font-semibold">
            ...
            >
              The amount to which the example percentage fee is applied.
            </span>
          </label>
          ...
          <label className="text-navy block text-sm font-semibold">
            ...
            <div className="border-border bg-background focus-within:ring-blue/30 mt-2 flex min-h-11 items-center rounded-lg border focus-within:ring-2">
              ...
              />
              <span className="text-muted pr-3" aria-hidden="true">
                %
              </span>
            </div>
            <span
              id="fx-percentage-help"
              className="text-muted mt-1 block text-xs font-normal"
            >
              Use the published percentage from a source you are researching, or
              experiment with an example rate.
            </span>
          </label>
        </div>
      </section>
        ...
        {result.status === "CALCULATED" ? (
          <>
            ...
            <p className="text-muted mt-2 text-sm">
              For {aud(numericAmount)} at {numericPercentage}%.
            </p>
          </>
        ) : (
          <div className="mt-4">
          ...
          <div className="mt-7 space-y-5 text-sm">
            <div>
              ...
              <p className="text-muted mt-1 leading-6">
                A percentage fee applied once to the hypothetical amount entered
                above.
              </p>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-2">
                {result.steps.map((step) => (
                  ...
                  >
                    ...
                    <code className="text-muted mt-1 block overflow-x-auto text-xs">
            ...
            <div className="border-border border-t pt-5">
              ...
              <p className="text-muted mt-1 leading-6">
                Not applicable in educational mode. The fee percentage is
                entered by you and is not presented as a verified provider fee.
              </p>
            </div>
          </div>
        )}
