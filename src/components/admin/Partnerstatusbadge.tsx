...
export const affiliatePartnershipRepository = createRepository(prisma.affiliatePartnership);
export const affiliateProgramRepository = createRepository(prisma.affiliateProgram);