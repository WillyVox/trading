...
import {
  ...
  buildBrandOgImage,
  type FeaturedImageConcept,
} from "@/lib/articles/import/featured-image-svg";
...
const PAGE_IMAGES: PageImageSpec[] = [
  ...
  {
    outputPath: "images/articles/share-trading-for-beginners.png",
    concept: "steps",
  },
  {
    outputPath:
      "images/articles/how-to-start-investing-in-crypto-for-beginners.png",
    concept: "learn",
  },
  {
    outputPath: "images/articles/simple-steps-to-buy-cryptocurrency.png",
    concept: "learn",
  },
];
...
async function main() {
  ...
  for (const spec of PAGE_IMAGES) {
    const svg = buildFeaturedImageSvg(
      {
        cryptoAssetSlugs: spec.cryptoAssetSlug
          ? [spec.cryptoAssetSlug]
          : undefined,
      },
      spec.concept
    );
